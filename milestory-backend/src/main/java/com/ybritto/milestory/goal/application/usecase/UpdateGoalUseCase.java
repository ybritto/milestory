...
public class UpdateGoalUseCase {
    ...
    public Goal update(UUID goalId, UpdateGoalCommand command) {
        UUID id = Objects.requireNonNull(goalId, "goalId must not be null");
        UpdateGoalCommand draft = Objects.requireNonNull(command, "command must not be null");
        ...
        return goalPersistencePort.save(updated);
    }
